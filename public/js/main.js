...
function openOverlay(el) {
  ...
  document.querySelector(".form-image p strong").textContent = el.closest(".pet-card").querySelector(".pet-name").textContent.trim() + "."
  document.querySelector(".form-image img").src = el.closest(".pet-card").querySelector(".pet-card-photo img").src
